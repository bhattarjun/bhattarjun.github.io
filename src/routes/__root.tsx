  ...
  head: () => ({
    meta: [
      ...
      { title: "Arjun Bhatt — Full-Stack Software Engineer" },
      {
        name: "description",
        content:
          "Portfolio of Arjun Bhatt, full-stack software engineer working with .NET Core, React, Next.js, Angular and Azure.",
      },
      { name: "author", content: "Arjun Bhatt" },
      { property: "og:site_name", content: "Arjun Bhatt" },
